...
public class AttributeTests
{
    ...
    public void AttributeValuesTest()
    {
        ...
        {
            Assert.That(attributes, Has.Member((Attribute)i));
        }
    }
    ...
    public void AttributesDisplayValuesTest(Attribute attribute, string name) => Assert.That(attribute.GetDisplayValue(), Is.EqualTo(name));
